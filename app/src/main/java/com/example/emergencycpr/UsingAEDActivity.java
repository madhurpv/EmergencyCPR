...
public class UsingAEDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_using_aedactivity);
        ...
        String videoPath = "android.resource://" + getPackageName() + "/" + R.raw.usingaed;
